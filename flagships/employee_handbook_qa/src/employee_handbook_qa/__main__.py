...
def main() -> None:
    p = argparse.ArgumentParser(description="Employee question → cited answer from the company handbook.")
    ...
    p.add_argument("--out", type=Path, default=Path("employee_handbook_qa.md"))
    args = p.parse_args()
