...
def main() -> None:
    p = argparse.ArgumentParser(description="PagerDuty alert → matched runbook section with cited remediation steps.")
    ...
    p.add_argument("--out", type=Path, default=Path("incident_runbook_lookup.md"))
    args = p.parse_args()
