...
class ChecklistItem(BaseModel):
    ...
    evidence_note: str = Field(
        ...,
        max_length=500,
        description="What evidence is present, what is missing, or why the item is incomplete.",
    )
...
class KYCReview(BaseModel):
    ...
    edd_required: bool = Field(
        ...,
        description="Whether Enhanced Due Diligence is required before account opening.",
    )
