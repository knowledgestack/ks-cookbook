"""pydantic-ai agent for Insurance Policy Comparison."""
...
SYSTEM = """\
You are an expert producing a Insurance Policy Comparison. Make at most 3 tool calls total. Use ONLY `list_contents` and `read`
...
async def run_agent(*, input_text: str, corpus_folder_id: str, model: str) -> PolicyComparison:
