"""pydantic-ai agent for Sales Battlecard Generator."""
...
SYSTEM = """\
You are an expert producing a Sales Battlecard Generator. Make at most 3 tool calls total. Use ONLY `list_contents` and `read`
...
async def run_agent(*, input_text: str, corpus_folder_id: str, model: str) -> Battlecard:
