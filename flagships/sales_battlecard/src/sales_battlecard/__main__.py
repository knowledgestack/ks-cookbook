...
def main() -> None:
    p = argparse.ArgumentParser(description="Competitor name → battlecard with differentiators, objection handlers, win themes.")
    ...
    p.add_argument("--out", type=Path, default=Path("sales_battlecard.md"))
    args = p.parse_args()
