...
def main() -> None:
    p = argparse.ArgumentParser(description="Proposed SOW → completeness check against template + methodology.")
    ...
    p.add_argument("--out", type=Path, default=Path("sow_scope_validator.md"))
    args = p.parse_args()
