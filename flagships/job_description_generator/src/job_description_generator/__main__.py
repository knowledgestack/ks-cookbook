...
def main() -> None:
    p = argparse.ArgumentParser(description="Role title → full JD grounded in leveling criteria + comp bands.")
    ...
    p.add_argument("--out", type=Path, default=Path("job_description_generator.md"))
    args = p.parse_args()
