"""pydantic-ai agent for Privacy Impact Assessment."""
...
SYSTEM = """\
You are an expert producing a Privacy Impact Assessment. Make at most 3 tool calls total. Use ONLY `list_contents` and `read`
...
async def run_agent(*, input_text: str, corpus_folder_id: str, model: str) -> PIAMemo:
