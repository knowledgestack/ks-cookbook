...
def main() -> None:
    p = argparse.ArgumentParser(description="New feature description → PIA memo citing GDPR + company template.")
    ...
    p.add_argument("--out", type=Path, default=Path("privacy_impact_assessment.md"))
    args = p.parse_args()
