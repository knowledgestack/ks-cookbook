...
async def _run(in_path: Path, out_path: Path, *, query_column: str, new_column: str,
               concurrency: int, fail_fast: bool) -> None:
...
def main() -> None:
    ...
    parser.add_argument("--column", default="research_summary",
        help="Name of the column to write the summary into (default: research_summary).")
    parser.add_argument("--concurrency", type=int, default=5,
        help="Max concurrent MCP calls (default: 5).")
