...
- CRM notes, call transcripts, account plans, and product collateral
- Renewal summaries, support tickets, and success playbooks
- Competitive docs, objections libraries, and messaging frameworks
...
```bash
uv run python recipes/prospecting_email_personalizer/recipe.py --help
```
...
## Live verified — prospecting_email_personalizer

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~40.1s).
