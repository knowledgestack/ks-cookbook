...
```bash
uv run python recipes/regulations_comment_summarizer/recipe.py --help
```
...
## Live verified — regulations_comment_summarizer

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~18.5s).
