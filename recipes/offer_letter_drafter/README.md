...
```bash
uv run python recipes/offer_letter_drafter/recipe.py --help
```
...
## Live verified — offer_letter_drafter

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~62.3s).
