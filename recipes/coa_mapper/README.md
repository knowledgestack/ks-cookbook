...
```bash
uv run python recipes/coa_mapper/recipe.py --help
```
...
## Live verified — coa_mapper

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~60.4s).
