...
```bash
uv run python recipes/cloud_cost_anomaly/recipe.py --help
```
...
## Live verified — cloud_cost_anomaly

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~64.0s).
