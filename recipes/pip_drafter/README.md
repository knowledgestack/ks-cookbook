...
```bash
uv run python recipes/pip_drafter/recipe.py --help
```
...
## Live verified — pip_drafter

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~30.2s).
