...
```bash
uv run python recipes/stakeholder_map_drafter/recipe.py --help
```
...
## Live verified — stakeholder_map_drafter

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~20.1s).
