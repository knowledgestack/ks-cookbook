...
```bash
uv run python recipes/obligation_tracker/recipe.py --help
```
...
## Live verified — obligation_tracker

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~17.6s).
