...
class PriorArtCandidate(BaseModel):
    reference: str = Field(
        ..., max_length=200, description="e.g. US-10,123,456-B2 or EP-3,123,456-A1"
    )
...
PROMPT = """You search prior art. Compare the claim to USPTO/EPO references in
