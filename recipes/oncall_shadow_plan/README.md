...
```bash
uv run python recipes/oncall_shadow_plan/recipe.py --help
```
...
## Live verified — oncall_shadow_plan

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~16.5s).
