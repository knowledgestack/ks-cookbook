...
```bash
uv run python recipes/meddic_call_coach/recipe.py --help
```
...
## Live verified — meddic_call_coach

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~70.2s).
