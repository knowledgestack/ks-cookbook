...
```bash
uv run python recipes/discharge_summary_rewrite/recipe.py --help
```
...
## Live verified — discharge_summary_rewrite

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~33.5s).
