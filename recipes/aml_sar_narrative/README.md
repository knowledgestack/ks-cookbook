...
```bash
uv run python recipes/aml_sar_narrative/recipe.py --help
```
...
## Live verified — aml_sar_narrative

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~21.1s).
