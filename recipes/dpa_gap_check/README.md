...
```bash
uv run python recipes/dpa_gap_check/recipe.py --help
```
...
## Live verified — dpa_gap_check

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~6.7s).
