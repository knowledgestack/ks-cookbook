...
```bash
uv run python recipes/escalation_decision/recipe.py --help
```
...
## Live verified — escalation_decision

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~26.2s).
