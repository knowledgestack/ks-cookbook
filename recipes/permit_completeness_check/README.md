...
```bash
uv run python recipes/permit_completeness_check/recipe.py --help
```
...
## Live verified — permit_completeness_check

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~40.3s).
