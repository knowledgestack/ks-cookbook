...
```bash
uv run python recipes/hipaa_baa_gap/recipe.py --help
```
...
## Live verified — hipaa_baa_gap

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~33.8s).
