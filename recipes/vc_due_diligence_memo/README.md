...
```bash
uv run python recipes/vc_due_diligence_memo/recipe.py --help
```
...
## Live verified — vc_due_diligence_memo

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~105.6s).
