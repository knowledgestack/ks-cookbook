...
```bash
uv run python recipes/bcp_drill_plan/recipe.py --help
```
...
## Live verified — bcp_drill_plan

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~14.9s).
