...
```bash
uv run python recipes/vendor_security_review/recipe.py --help
```
...
## Live verified — vendor_security_review

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~25.0s).
