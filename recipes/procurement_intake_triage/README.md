...
- Vendor contracts, invoices, statements of work, and renewal notices
- Purchase orders, policy docs, AP exports, and GL mappings
- Exception logs, approvals, and month-end checklists
...
```bash
uv run python recipes/procurement_intake_triage/recipe.py --help
```
...
## Live verified — procurement_intake_triage

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~20.4s).
