...
```bash
uv run python recipes/incident_postmortem/recipe.py --help
```
...
## Live verified — incident_postmortem

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~34.2s).
