...
```bash
uv run python recipes/inbound_lead_router/recipe.py --help
```
...
## Live verified — inbound_lead_router

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~25.1s).
