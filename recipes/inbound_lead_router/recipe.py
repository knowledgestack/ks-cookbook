...
PROMPT = """You route inbound leads per our ICP + segmentation rules in
...
def main() -> None:
    ...
    p.add_argument(
        "--payload", required=True, help="JSON string or plain-text lead payload from the form."
    )
    args = p.parse_args()
