...
class StructuredFNOL(BaseModel):
    ...
    loss_location: str
    loss_type: str = Field(
        ..., pattern="^(collision|comprehensive|property|liability|workers_comp|other)$"
    )
...
PROMPT = """You structure FNOLs. Extract policy number, insured, parties, loss type,
