...
```bash
uv run python recipes/icp_matcher/recipe.py --help
```
...
## Live verified — icp_matcher

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~21.4s).
