...
```bash
uv run python recipes/churn_risk_flags/recipe.py --help
```
...
## Live verified — churn_risk_flags

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~18.7s).
