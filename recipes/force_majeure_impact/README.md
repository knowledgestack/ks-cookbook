...
- Contracts, amendments, MSAs, DPAs, and legal playbooks
- Redlines, obligations matrices, procurement terms, and policy exceptions
- Counsel notes, negotiation emails, and renewal summaries
...
```bash
uv run python recipes/force_majeure_impact/recipe.py --help
```
...
## Live verified — force_majeure_impact

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~34.6s).
