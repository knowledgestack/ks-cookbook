...
- Security policies, SOC 2 controls, ISO statements, and audit evidence
- Runbooks, incident reports, vulnerability findings, and change records
- Access logs, entitlement exports, and exception approvals
...
```bash
uv run python recipes/security_awareness_quiz/recipe.py --help
```
...
## Live verified — security_awareness_quiz
