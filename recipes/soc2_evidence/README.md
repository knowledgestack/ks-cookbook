...
```bash
uv run python recipes/soc2_evidence/recipe.py --help
```
...
## Live verified — soc2_evidence

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~1.8s).
