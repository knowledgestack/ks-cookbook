...
```bash
uv run python recipes/launch_email_variants/recipe.py --help
```
...
## Live verified — launch_email_variants

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~37.3s).
