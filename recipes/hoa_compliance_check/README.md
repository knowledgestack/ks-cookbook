...
```bash
uv run python recipes/hoa_compliance_check/recipe.py --help
```
...
## Live verified — hoa_compliance_check

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~5.5s).
