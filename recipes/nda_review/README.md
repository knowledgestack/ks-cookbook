...
```bash
uv run python recipes/nda_review/recipe.py --help
```
...
## Live verified — nda_review

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~45.0s).
