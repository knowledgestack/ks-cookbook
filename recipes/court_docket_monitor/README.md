...
```bash
uv run python recipes/court_docket_monitor/recipe.py --help
```
...
## Live verified — court_docket_monitor

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~5.4s).
