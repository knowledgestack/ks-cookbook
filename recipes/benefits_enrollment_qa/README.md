...
```bash
uv run python recipes/benefits_enrollment_qa/recipe.py --help
```
...
## Live verified — benefits_enrollment_qa

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~21.8s).
