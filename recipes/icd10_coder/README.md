...
- Clinical notes, discharge summaries, payer policies, and coding manuals
- Formularies, safety bulletins, treatment guidelines, and medical references
- Claims intake narratives, denial letters, and utilization review documents
...
```bash
uv run python recipes/icd10_coder/recipe.py --help
```

- Optional sample input available in `recipes/icd10_coder/sample_inputs/` (for example: `deid_visit_001.txt`)
...
## Live verified — icd10_coder

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~23.0s).
