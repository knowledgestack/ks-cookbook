...
PROMPT = """You write support macros. Ground answers in KB articles in
...
def main() -> None:
    ...
    p.add_argument("--ticket-type", required=True, help="e.g. 'API key rotation request'")
    args = p.parse_args()
