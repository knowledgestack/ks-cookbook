...
```bash
uv run python recipes/pci_scope_review/recipe.py --help
```
...
## Live verified — pci_scope_review

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~53.9s).
