...
PROMPT = """You match GovCon opportunities. Read SAM.gov notices in
...
def main() -> None:
    ...
    p.add_argument(
        "--capabilities", required=True, help="Comma-separated, e.g. 'RAG,citations,PII redaction'."
    )
    args = p.parse_args()
