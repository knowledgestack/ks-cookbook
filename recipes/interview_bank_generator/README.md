...
```bash
uv run python recipes/interview_bank_generator/recipe.py --help
```
...
## Live verified — interview_bank_generator

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~33.9s).
