...
```bash
uv run python recipes/analyst_inquiry_responder/recipe.py --help
```
...
## Live verified — analyst_inquiry_responder

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~23.3s).
