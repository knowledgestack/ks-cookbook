...
```bash
uv run python recipes/interview_competency_grader/recipe.py --help
```
...
## Live verified — interview_competency_grader

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~34.5s).
