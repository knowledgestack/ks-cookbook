...
```bash
uv run python recipes/clause_extractor/recipe.py --help
```
...
## Live verified — clause_extractor

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~66.7s).
