...
```bash
uv run python recipes/tech_debt_ledger/recipe.py --help
```
...
## Live verified — tech_debt_ledger

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~37.1s).
