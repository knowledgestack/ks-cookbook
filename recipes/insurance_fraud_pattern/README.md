...
```bash
uv run python recipes/insurance_fraud_pattern/recipe.py --help
```
...
## Live verified — insurance_fraud_pattern

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~22.5s).
