...
```bash
uv run python recipes/sre_runbook_gap_check/recipe.py --help
```
...
## Live verified — sre_runbook_gap_check

Verified end-to-end on the unified cookbook corpus on **2026-04-28** (model `gpt-4o-mini`, ~45.3s).
