---
title: "Loan Covenant Monitor agent — grounded in your docs, with citations"
description: "Banking flagship — compare quarterly financials against credit agreement covenants, flag breaches with citations."
keywords: ["loan covenant monitor", "Banking agent", "Banking RAG", "document AI", "MCP"]
---

# Loan Covenant Monitor

Banking flagship — compare quarterly financials against credit agreement covenants, flag breaches with citations.
...
- Enumerates the `Banking` corpus folder, reads relevant chunks, and produces a structured pydantic output.
...
## Why citations matter for Banking

In Banking, an unsourced AI answer is a liability. Knowledge Stack threads `[chunk:<uuid>]` markers through every read, and the schema rejects outputs that lack them. That's the difference between a demo and a control your auditors accept.

## Source

- Flagship: [`flagships/loan_covenant_monitor/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/loan_covenant_monitor)
