---
title: "Foia Response Drafter agent — grounded in your docs, with citations"
description: "Government flagship — FOIA response letter with exemption analysis (raw OpenAI + MCP)."
keywords: ["foia response drafter", "Government agent", "Government RAG", "document AI", "MCP"]
---

# Foia Response Drafter

Government flagship — FOIA response letter with exemption analysis (raw OpenAI + MCP).
...
- Enumerates the `Government` corpus folder, reads relevant chunks, and produces a structured pydantic output.
...
## Why citations matter for Government

In Government, an unsourced AI answer is a liability. Knowledge Stack threads `[chunk:<uuid>]` markers through every read, and the schema rejects outputs that lack them. That's the difference between a demo and a control your auditors accept.

## Source

- Flagship: [`flagships/foia_response_drafter/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/foia_response_drafter)
