---
title: "Well Log Summarizer agent — grounded in your docs, with citations"
description: "Energy flagship — summarize drilling reports + well logs with HSE / equipment / formation events, fully cited."
keywords: ["well log summarizer", "Energy agent", "Energy RAG", "document AI", "MCP"]
---

# Well Log Summarizer

Energy flagship — summarize drilling reports + well logs with HSE / equipment / formation events, fully cited.
...
- Enumerates the `Energy` corpus folder, reads relevant chunks, and produces a structured pydantic output.
...
## Why citations matter for Energy

In Energy, an unsourced AI answer is a liability. Knowledge Stack threads `[chunk:<uuid>]` markers through every read, and the schema rejects outputs that lack them. That's the difference between a demo and a control your auditors accept.

## Source

- Flagship: [`flagships/well_log_summarizer/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/well_log_summarizer)
