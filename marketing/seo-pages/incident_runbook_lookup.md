---
title: "Incident Runbook Lookup agent — grounded in your docs, with citations"
description: "PagerDuty alert → matched runbook section with cited remediation steps."
keywords: ["incident runbook lookup", "General agent", "General RAG", "document AI", "MCP"]
---
...
- Flagship: [`flagships/incident_runbook_lookup/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/incident_runbook_lookup)
