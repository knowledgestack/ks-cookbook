---
title: "Condo Board Decision Pack agent — grounded in your docs, with citations"
description: "CondoStack flagship — adjudicate a unit-owner architectural request with a board-ready decision memo citing CC&Rs, bylaws, ACC guidelines, reserve-fund impact, and historical minutes."
keywords: ["condo board decision pack", "General agent", "General RAG", "document AI", "MCP"]
---

# Condo Board Decision Pack

CondoStack flagship — adjudicate a unit-owner architectural request with a board-ready decision memo citing CC&Rs, bylaws, ACC guidelines, reserve-fund impact, and historical minutes.
...
- Flagship: [`flagships/condo_board_decision_pack/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/condo_board_decision_pack)
