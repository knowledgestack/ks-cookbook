---
title: "Prior Auth Letter agent — grounded in your docs, with citations"
description: "Prior-authorization letter drafter — clinical scenario → cited appeal letter grounded in a KS policy corpus."
keywords: ["prior auth letter", "General agent", "General RAG", "document AI", "MCP"]
---

# Prior Auth Letter

Prior-authorization letter drafter — clinical scenario → cited appeal letter grounded in a KS policy corpus.
...
- Flagship: [`flagships/prior_auth_letter/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/prior_auth_letter)
