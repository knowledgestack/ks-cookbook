---
title: "Grant Compliance Checker agent — grounded in your docs, with citations"
description: "Sub-awardee activity → compliance check citing the NOFO + federal regs."
keywords: ["grant compliance checker", "General agent", "General RAG", "document AI", "MCP"]
---
...
- Flagship: [`flagships/grant_compliance_checker/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/grant_compliance_checker)
