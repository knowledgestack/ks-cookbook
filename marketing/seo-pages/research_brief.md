---
title: "Research Brief agent — grounded in your docs, with citations"
description: "Topic → cited .docx research brief using pydantic-ai + Knowledge Stack MCP."
keywords: ["research brief", "General agent", "General RAG", "document AI", "MCP"]
---

# Research Brief

Topic → cited .docx research brief using pydantic-ai + Knowledge Stack MCP.
...
- Flagship: [`flagships/research_brief/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/research_brief)
