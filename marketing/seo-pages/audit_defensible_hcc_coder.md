---
title: "Audit Defensible Hcc Coder agent — grounded in your docs, with citations"
description: "Healthcare flagship — assign HCC / ICD-10 codes with line-level rationales and chunk-level source citations for CMS audit defense."
keywords: ["audit defensible hcc coder", "Healthcare agent", "Healthcare RAG", "document AI", "MCP"]
---

# Audit Defensible Hcc Coder

Healthcare flagship — assign HCC / ICD-10 codes with line-level rationales and chunk-level source citations for CMS audit defense.
...
- Flagship: [`flagships/audit_defensible_hcc_coder/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/audit_defensible_hcc_coder)
