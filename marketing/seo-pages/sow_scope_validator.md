---
title: "Sow Scope Validator agent — grounded in your docs, with citations"
description: "Proposed SOW → completeness check against template + methodology."
keywords: ["sow scope validator", "General agent", "General RAG", "document AI", "MCP"]
---
...
- Flagship: [`flagships/sow_scope_validator/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/sow_scope_validator)
