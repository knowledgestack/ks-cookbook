---
title: "Construction Rfi Agent agent — grounded in your docs, with citations"
description: "Construction flagship — draft a cited RFI response cross-referencing CSI specs, drawings, and prior submittals."
keywords: ["construction rfi agent", "Construction agent", "Construction RAG", "document AI", "MCP"]
---

# Construction Rfi Agent

Construction flagship — draft a cited RFI response cross-referencing CSI specs, drawings, and prior submittals.
...
- Enumerates the `Construction` corpus folder, reads relevant chunks, and produces a structured pydantic output.
...
## Why citations matter for Construction

In Construction, an unsourced AI answer is a liability. Knowledge Stack threads `[chunk:<uuid>]` markers through every read, and the schema rejects outputs that lack them. That's the difference between a demo and a control your auditors accept.

## Source

- Flagship: [`flagships/construction_rfi_agent/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/construction_rfi_agent)
