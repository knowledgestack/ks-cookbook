---
title: "Realtime Voice Sdr agent — grounded in your docs, with citations"
description: "Sales flagship — live SDR agent on the OpenAI Realtime API with KS MCP tool proxy (voice + text)."
keywords: ["realtime voice sdr", "Sales agent", "Sales RAG", "document AI", "MCP"]
---

# Realtime Voice Sdr

Sales flagship — live SDR agent on the OpenAI Realtime API with KS MCP tool proxy (voice + text).
...
- Flagship: [`flagships/realtime_voice_sdr/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/realtime_voice_sdr)
