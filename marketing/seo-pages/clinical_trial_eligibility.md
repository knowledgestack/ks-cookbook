---
title: "Clinical Trial Eligibility agent — grounded in your docs, with citations"
description: "Healthcare flagship — patient eligibility assessment against real clinical trial criteria (pydantic-ai)."
keywords: ["clinical trial eligibility", "Healthcare agent", "Healthcare RAG", "document AI", "MCP"]
---

# Clinical Trial Eligibility

Healthcare flagship — patient eligibility assessment against real clinical trial criteria (pydantic-ai).
...
- Flagship: [`flagships/clinical_trial_eligibility/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/clinical_trial_eligibility)
