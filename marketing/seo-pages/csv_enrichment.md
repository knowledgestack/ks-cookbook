---
title: "Csv Enrichment agent — grounded in your docs, with citations"
description: "LangGraph agent that enriches CSV rows using the KS knowledge base via MCP."
keywords: ["csv enrichment", "General agent", "General RAG", "document AI", "MCP"]
---

# Csv Enrichment

LangGraph agent that enriches CSV rows using the KS knowledge base via MCP.
...
- Flagship: [`flagships/csv_enrichment/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/csv_enrichment)
