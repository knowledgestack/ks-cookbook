---
title: "Contract Redline With Provenance agent — grounded in your docs, with citations"
description: "Legal flagship — produce a Word redline memo where every proposed edit is bound to both the offending clause chunk and the governing playbook rule chunk."
keywords: ["contract redline with provenance", "Legal agent", "Legal RAG", "document AI", "MCP"]
---

# Contract Redline With Provenance

Legal flagship — produce a Word redline memo where every proposed edit is bound to both the offending clause chunk and the governing playbook rule chunk.
...
- Flagship: [`flagships/contract_redline_with_provenance/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/contract_redline_with_provenance)
