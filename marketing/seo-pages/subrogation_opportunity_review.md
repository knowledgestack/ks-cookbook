---
title: "Subrogation Opportunity Review agent — grounded in your docs, with citations"
description: "Insurance flagship — P&C subrogation recovery opportunity assessment (raw OpenAI function calling)."
keywords: ["subrogation opportunity review", "Insurance agent", "Insurance RAG", "document AI", "MCP"]
---

# Subrogation Opportunity Review

Insurance flagship — P&C subrogation recovery opportunity assessment (raw OpenAI function calling).
...
- Enumerates the `Insurance` corpus folder, reads relevant chunks, and produces a structured pydantic output.
...
## Why citations matter for Insurance

In Insurance, an unsourced AI answer is a liability. Knowledge Stack threads `[chunk:<uuid>]` markers through every read, and the schema rejects outputs that lack them. That's the difference between a demo and a control your auditors accept.

## Source

- Flagship: [`flagships/subrogation_opportunity_review/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/subrogation_opportunity_review)
