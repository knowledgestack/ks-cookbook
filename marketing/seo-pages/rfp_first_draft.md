---
title: "Rfp First Draft agent — grounded in your docs, with citations"
description: "Sales flagship — draft RFP responses grounded in past proposals (pydantic-ai)."
keywords: ["rfp first draft", "Sales agent", "Sales RAG", "document AI", "MCP"]
---

# Rfp First Draft

Sales flagship — draft RFP responses grounded in past proposals (pydantic-ai).
...
- Flagship: [`flagships/rfp_first_draft/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/rfp_first_draft)
