---
title: "Earnings Risk Analyzer agent — grounded in your docs, with citations"
description: "Finance flagship — 10-K risk-flag analyst memo from real SEC EDGAR filings."
keywords: ["earnings risk analyzer", "Finance agent", "Finance RAG", "document AI", "MCP"]
---

# Earnings Risk Analyzer

Finance flagship — 10-K risk-flag analyst memo from real SEC EDGAR filings.
...
- Enumerates the `Finance` corpus folder, reads relevant chunks, and produces a structured pydantic output.
...
## Why citations matter for Finance

In Finance, an unsourced AI answer is a liability. Knowledge Stack threads `[chunk:<uuid>]` markers through every read, and the schema rejects outputs that lack them. That's the difference between a demo and a control your auditors accept.

## Source

- Flagship: [`flagships/earnings_risk_analyzer/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/earnings_risk_analyzer)
