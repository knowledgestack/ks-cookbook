---
title: "Lease Abstract agent — grounded in your docs, with citations"
description: "Commercial lease → one-page cited lease abstract (raw OpenAI function calling)."
keywords: ["lease abstract", "General agent", "General RAG", "document AI", "MCP"]
---

# Lease Abstract

Commercial lease → one-page cited lease abstract (raw OpenAI function calling).
...
- Flagship: [`flagships/lease_abstract/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/lease_abstract)
