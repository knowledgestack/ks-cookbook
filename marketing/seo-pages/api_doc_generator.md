---
title: "Api Doc Generator agent — grounded in your docs, with citations"
description: "Endpoint name → developer docs grounded in API spec + style guide."
keywords: ["api doc generator", "General agent", "General RAG", "document AI", "MCP"]
---
...
- Flagship: [`flagships/api_doc_generator/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/api_doc_generator)
