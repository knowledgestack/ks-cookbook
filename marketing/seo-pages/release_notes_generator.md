---
title: "Release Notes Generator agent — grounded in your docs, with citations"
description: "Release tag → customer-facing notes grounded in specs + migration guide."
keywords: ["release notes generator", "General agent", "General RAG", "document AI", "MCP"]
---
...
- Flagship: [`flagships/release_notes_generator/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/release_notes_generator)
