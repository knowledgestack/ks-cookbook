---
title: "Legal Matter Intake agent — grounded in your docs, with citations"
description: "Sertain flagship — produce a new-matter intake dossier citing the firm's conflicts database, practice playbook, jurisdiction rules, and fee schedule."
keywords: ["legal matter intake", "General agent", "General RAG", "document AI", "MCP"]
---

# Legal Matter Intake

Sertain flagship — produce a new-matter intake dossier citing the firm's conflicts database, practice playbook, jurisdiction rules, and fee schedule.
...
- Flagship: [`flagships/legal_matter_intake/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/legal_matter_intake)
