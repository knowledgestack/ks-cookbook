---
title: "Claim Adjudication Memo agent — grounded in your docs, with citations"
description: "P&C claim summary → coverage-analysis memo grounded in policy wording (LangGraph ReAct)."
keywords: ["claim adjudication memo", "General agent", "General RAG", "document AI", "MCP"]
---

# Claim Adjudication Memo

P&C claim summary → coverage-analysis memo grounded in policy wording (LangGraph ReAct).
...
- Flagship: [`flagships/claim_adjudication_memo/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/claim_adjudication_memo)
