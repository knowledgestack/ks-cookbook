---
title: "Nerc Compliance Evidence agent — grounded in your docs, with citations"
description: "Energy flagship — NERC CIP compliance evidence pack memo (pydantic-ai)."
keywords: ["nerc compliance evidence", "Energy agent", "Energy RAG", "document AI", "MCP"]
---

# Nerc Compliance Evidence

Energy flagship — NERC CIP compliance evidence pack memo (pydantic-ai).
...
- Flagship: [`flagships/nerc_compliance_evidence/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/nerc_compliance_evidence)
