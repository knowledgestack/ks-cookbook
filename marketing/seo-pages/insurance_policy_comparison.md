---
title: "Insurance Policy Comparison agent — grounded in your docs, with citations"
description: "Current vs proposed policy → side-by-side analysis with coverage gaps."
keywords: ["insurance policy comparison", "General agent", "General RAG", "document AI", "MCP"]
---
...
- Flagship: [`flagships/insurance_policy_comparison/`](https://github.com/knowledgestack/ks-cookbook/tree/main/flagships/insurance_policy_comparison)
