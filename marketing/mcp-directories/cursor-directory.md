# Submission packet — Cursor MCP Directory

**Submission URL:** https://cursor.directory/mcp
**Submission format:** PR to `pontusab/cursor.directory` with new MCP entry.

**Note:** Provide one-click install deeplink: `cursor://anysphere.cursor-deeplink/mcp/install?name=knowledgestack&config=<base64>`.
