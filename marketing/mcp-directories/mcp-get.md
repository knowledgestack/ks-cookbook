# Submission packet — mcp-get registry

**Submission URL:** https://github.com/michaellatman/mcp-get
**Submission format:** PR adding entry to `packages.json` with name, command, args, env schema.
