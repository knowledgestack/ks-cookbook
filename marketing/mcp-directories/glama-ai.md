# Submission packet — Glama (glama.ai/mcp)

**Submission URL:** https://glama.ai/mcp/servers
**Submission format:** Auto-indexed from GitHub topic `mcp` + `mcp-server`. Add both topics to `ks-mcp` repo settings.

**Note:** Add a `claude-mcp` topic too — Glama uses it as a quality signal.
