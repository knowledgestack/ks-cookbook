# Submission packet — Smithery (smithery.ai)

**Submission URL:** https://smithery.ai/new
**Submission format:** GitHub repo URL + smithery.yaml in repo root.

**Note:** Add `smithery.yaml` to `ks-mcp` repo root with `startCommand: uvx knowledgestack-mcp` and config schema for `KS_API_KEY`.
